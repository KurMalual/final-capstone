...
class EquipmentRentalRequestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'equipment', 'equipment_name', 'equipment_image', 'equipment_price_per_day', 'farmer', 'status', 'message', 'operation_location', 'payment_method', 'created_at', 'updated_at']
